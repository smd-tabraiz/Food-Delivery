...
const Menu = () => {
  ...
  return (
    <div className="menu-page-container">
      <div className="mb-4">
        <BackButton to="/" label="Back to Restaurants" />
      </div>
      {loading ? (
        <p>Loading menus...</p>
      ) : error ? (
        ...
        <>
          ...
          <div className="menu-nav-bar shadow-sm">
            <div className="menu-nav-container">
              {menus.map((menu) => (
                <button
                  ...
                  onClick={() => {
                    const targetId = `category-${menu._id}`;
          ...
          <div className="menu-items-container mt-4">
            {menus.map((menu) => {
          ...
          return (
            <div key={menu._id} id={`category-${menu._id}`} className="menu-category-section mb-5">
              <div className="d-flex align-items-center">
                <h2 className="mr-2 font-weight-bold">{menu.category}</h2>
